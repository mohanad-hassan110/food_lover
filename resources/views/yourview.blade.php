...
<body>
    ...
    <header>
        ...
        <div class="content">
            ...
            <a href="#contact" class="btn btn-primary">Book a Table</a>
        </div>
    </header>
    <!-- Header End -->
    <main>
            ...
            <div class="container">
                <div class="contact-content">
                    <div class="contact-info">
                        <div>
                            <h3>ADDRESS</h3>
                            <p><i class="fa-solid fa-location-dot"></i> Hy El-gamaa , El Mansoura , Egypt</p>
                            <p><i class="fa-solid fa-phone"></i> Phone: 01010498956</p>
    ...
    <footer id="footer">
        <p>Copyright &copy; 2023 All rights reserved | made by mohanad hassan <b> 
    </footer>
</body>
